...
public class MockPayment {
	...
	public static String generateMockReference() {
		return String.format("%04d", RAND.nextInt(10000)) + "-" + String.format("%04d", RAND.nextInt(10000)) + "-"
				+ String.format("%04d", RAND.nextInt(10000)) + "-" + String.format("%04d", RAND.nextInt(10000));
	}
